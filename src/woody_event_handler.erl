...
-type meta_client() :: #{
    ...
    %% EV_CLIENT_RECEIVE | EV_CLIENT_RESOLVE_RESULT
    reason => woody_error:details(),
    %% EV_CLIENT_RECEIVE | EV_SERVICE_RESULT | EV_CLIENT_RESOLVE_RESULT
    status => status(),
    %% EV_CLIENT_RESOLVE_RESULT
    address => string(),
    %% EV_CLIENT_RESOLVE_RESULT | EV_CLIENT_RESOLVE_BEGIN
    host => string(),
    %% EV_SERVICE_RESULT
...
-type meta_server() :: #{
    ...
    %% EV_SERVER_RECEIVE
    url => woody:url(),
    %% EV_SERVER_RECEIVE | EV_SERVER_SEND | EV_SERVICE_HANDLER_RESULT
    status => status(),
    %% EV_SERVER_RECEIVE
    reason => woody_error:details(),
    %% EV_SERVER_SEND
    ...
    %% EV_INVOKE_SERVICE_HANDLER | EV_SERVICE_HANDLER_RESULT | EV_SERVER_SEND
    service => woody:service_name(),
    %% EV_INVOKE_SERVICE_HANDLER | EV_SERVICE_HANDLER_RESULT | EV_SERVER_SEND
    service_schema => woody:service(),
    %% EV_INVOKE_SERVICE_HANDLER | EV_SERVICE_HANDLER_RESULT | EV_SERVER_SEND
    ...
    ignore => boolean(),
    %% EV_SERVICE_HANDLER_RESULT
    except_class => woody_error:erlang_except(),
    %% EV_SERVICE_HANDLER_RESULT
    class => business | system,
    %% EV_SERVICE_HANDLER_RESULT
...
-type meta_internal_error() :: #{
    ...
    class := atom(),
    final => boolean(),
    %% Server handler failed and woody_server_thrift_http_handler:terminate/3
...
-type meta_client_cache() :: #{
    ...
    url := woody:url(),
    %% EV_CLIENT_CACHE_HIT | EV_CLIENT_CACHE_UPDATE
    result => woody:result()
}.
...
%% API
%%
-spec handle_event(event(), woody_state:st(), meta()) -> ok.
...
-spec handle_event(woody:ev_handlers(), event(), woody:rpc_id() | undefined, event_meta()) -> ok.
...
-spec format_rpc_id(woody:rpc_id() | undefined) -> msg().
...
-spec format_service_exception(_Exception, map(), options()) -> msg().
...
-spec format_service_reply(_Result, meta(), options()) -> msg().
                            ...
                            {{mg_stateproc_SignalArgs,
                                {init,
                                    {mg_stateproc_InitSignal,
                                        {bin,
                                            <<131, 109, 0, 0, 0, 24, 12, 0, 1, 11, 0, 1, 0, 0, 0, 12, 104, 103, 95, 99,
                                                116, 95, 104, 101, 108, 112, 101, 114, 0, 0>>}}},
                                                ...
                                                {legal_entity,
                                                    {russian_legal_entity,
                                                        {domain_RussianLegalEntity, <<"Hoofs & Horns OJSC">>,
                                                            ...
                                                            <<"Nezahualcoyotl 109 Piso 8, Centro, 06082, MEXICO">>,
                                                            <<"NaN">>, <<"Director">>, <<"Someone">>,
                                                            <<"100$ banknote">>,
                    ...
                    #{
                        args =>
                            {{mg_stateproc_CallArgs,
                                {bin,
                                    <<131, 104, 4, 100, 0, 11, 116, 104, 114, 105, 102, 116, 95, 99, 97, 108, 108, 100,
                                        0, 16, 112, 97, 114, 116, 121, 95, 109, 97, 110, 97, 103, 101, 109, 101, 110,
                                        116, 104, 2, 100, 0, 15, 80, 97, 114, 116, 121, 77, 97, 110, 97, 103, 101, 109,
                                        101, 110, 116, 100, 0, 11, 67, 114, 101, 97, 116, 101, 67, 108, 97, 105, 109,
                                        109, 0, 0, 2, 145, 11, 0, 2, 0, 0, 0, 11, 49, 67, 83, 72, 84, 104, 84, 69, 74,
                                        56, 52, 15, 0, 3, 12, 0, 0, 0, 4, 12, 0, 4, 11, 0, 1, 0, 0, 0, 11, 49, 67, 83,
                                        72, 84, 106, 75, 108, 51, 52, 75, 12, 0, 2, 12, 0, 1, 12, 0, 2, 8, 0, 1, 0, 0,
                                        0, 1, 0, 12, 0, 3, 8, 0, 1, 0, 0, 0, 1, 0, 12, 0, 1, 12, 0, 1, 12, 0, 1, 11, 0,
                                        1, 0, 0, 0, 18, 72, 111, 111, 102, 115, 32, 38, 32, 72, 111, 114, 110, 115, 32,
                                        79, 74, 83, 67, 11, 0, 2, 0, 0, 0, 10, 49, 50, 51, 52, 53, 48, 57, 56, 55, 54,
                                        11, 0, 3, 0, 0, 0, 13, 49, 50, 49, 51, 52, 53, 54, 55, 56, 57, 48, 49, 50, 11,
                                        0, 4, 0, 0, 0, 48, 78, 101, 122, 97, 104, 117, 97, 108, 99, 111, 121, 111, 116,
                                        108, 32, 49, 48, 57, 32, 80, 105, 115, 111, 32, 56, 44, 32, 67, 101, 110, 116,
                                        114, 111, 44, 32, 48, 54, 48, 56, 50, 44, 32, 77, 69, 88, 73, 67, 79, 11, 0, 5,
                                        0, 0, 0, 3, 78, 97, 78, 11, 0, 6, 0, 0, 0, 8, 68, 105, 114, 101, 99, 116, 111,
                                        114, 11, 0, 7, 0, 0, 0, 7, 83, 111, 109, 101, 111, 110, 101, 11, 0, 8, 0, 0, 0,
                                        13, 49, 48, 48, 36, 32, 98, 97, 110, 107, 110, 111, 116, 101, 12, 0, 9, 11, 0,
                                        1, 0, 0, 0, 19, 52, 50, 55, 54, 51, 48, 48, 48, 49, 48, 57, 48, 56, 51, 49, 50,
                                        56, 57, 51, 11, 0, 2, 0, 0, 0, 8, 83, 111, 109, 101, 66, 97, 110, 107, 11, 0, 3,
                                        0, 0, 0, 9, 49, 50, 51, 49, 50, 57, 56, 55, 54, 11, 0, 4, 0, 0, 0, 8, 54, 54,
                                        54, 52, 50, 54, 54, 54, 0, 0, 0, 0, 0, 0, 0, 0, 12, 0, 4, 11, 0, 1, 0, 0, 0, 11,
                                        49, 67, 83, 72, 84, 106, 75, 108, 51, 52, 75, 12, 0, 2, 12, 0, 4, 11, 0, 1, 0,
                                        0, 0, 11, 49, 67, 83, 72, 84, 106, 75, 108, 51, 52, 76, 12, 0, 2, 12, 0, 1, 12,
                                        0, 1, 11, 0, 1, 0, 0, 0, 3, 82, 85, 66, 0, 12, 0, 2, 12, 0, 1, 11, 0, 1, 0, 0,
                                        0, 19, 52, 50, 55, 54, 51, 48, 48, 48, 49, 48, 57, 48, 56, 51, 49, 50, 56, 57,
                                        51, 11, 0, 2, 0, 0, 0, 8, 83, 111, 109, 101, 66, 97, 110, 107, 11, 0, 3, 0, 0,
                                        0, 9, 49, 50, 51, 49, 50, 57, 56, 55, 54, 11, 0, 4, 0, 0, 0, 8, 54, 54, 54, 52,
                                        50, 54, 54, 54, 0, 0, 0, 0, 0, 0, 0, 0, 12, 0, 6, 11, 0, 1, 0, 0, 0, 11, 49, 67,
                                        83, 72, 84, 106, 75, 108, 51, 52, 77, 12, 0, 2, 12, 0, 5, 12, 0, 1, 8, 0, 1, 0,
                                        0, 0, 1, 0, 12, 0, 6, 11, 0, 1, 0, 0, 0, 0, 0, 12, 0, 2, 11, 0, 1, 0, 0, 0, 17,
                                        66, 97, 116, 116, 108, 101, 32, 82, 101, 97, 100, 121, 32, 83, 104, 111, 112, 0,
                                        11, 0, 3, 0, 0, 0, 11, 49, 67, 83, 72, 84, 106, 75, 108, 51, 52, 75, 11, 0, 4,
                                        0, 0, 0, 11, 49, 67, 83, 72, 84, 106, 75, 108, 51, 52, 76, 0, 0, 0, 0, 12, 0, 6,
                                        11, 0, 1, 0, 0, 0, 11, 49, 67, 83, 72, 84, 106, 75, 108, 51, 52, 77, 12, 0, 2,
                                        12, 0, 12, 12, 0, 1, 11, 0, 1, 0, 0, 0, 3, 82, 85, 66, 0, 0, 0, 0, 0, 0>>},
                                {mg_stateproc_Machine, <<"party">>, <<"1CSHThTEJ84">>,
                                    [
                                        {mg_stateproc_Event, 1, <<"2019-08-13T07:52:11.080519Z">>, undefined,
                                            {arr, [
                                                ...
                                                {bin,
                                                    <<131, 104, 2, 100, 0, 13, 112, 97, 114, 116, 121, 95, 99, 104, 97,
                                                        110, 103, 101, 115, 108, 0, 0, 0, 2, 104, 2, 100, 0, 13, 112,
                                                        97, 114, 116, 121, 95, 99, 114, 101, 97, 116, 101, 100, 104, 4,
                                                        100, 0, 20, 112, 97, 121, 112, 114, 111, 99, 95, 80, 97, 114,
                                                        116, 121, 67, 114, 101, 97, 116, 101, 100, 109, 0, 0, 0, 11, 49,
                                                        67, 83, 72, 84, 104, 84, 69, 74, 56, 52, 104, 2, 100, 0, 23,
                                                        100, 111, 109, 97, 105, 110, 95, 80, 97, 114, 116, 121, 67, 111,
                                                        110, 116, 97, 99, 116, 73, 110, 102, 111, 109, 0, 0, 0, 12, 104,
                                                        103, 95, 99, 116, 95, 104, 101, 108, 112, 101, 114, 109, 0, 0,
                                                        0, 27, 50, 48, 49, 57, 45, 48, 56, 45, 49, 51, 84, 48, 55, 58,
                                                        53, 50, 58, 49, 49, 46, 48, 55, 50, 56, 51, 53, 90, 104, 2, 100,
                                                        0, 16, 114, 101, 118, 105, 115, 105, 111, 110, 95, 99, 104, 97,
                                                        110, 103, 101, 100, 104, 3, 100, 0, 28, 112, 97, 121, 112, 114,
                                                        111, 99, 95, 80, 97, 114, 116, 121, 82, 101, 118, 105, 115, 105,
                                                        111, 110, 67, 104, 97, 110, 103, 101, 100, 109, 0, 0, 0, 27, 50,
                                                        48, 49, 57, 45, 48, 56, 45, 49, 51, 84, 48, 55, 58, 53, 50, 58,
                                                        49, 49, 46, 48, 55, 50, 56, 51, 53, 90, 97, 0, 106>>}
                                            ]}}
                                    ],
                                    ...
                                    {mg_stateproc_Content, undefined,
                                        {obj, #{
                                            {str, <<"aux_state">>} =>
                                                {bin,
                                                    <<131, 116, 0, 0, 0, 2, 100, 0, 20, 112, 97, 114, 116, 121, 95, 114,
                                                        101, 118, 105, 115, 105, 111, 110, 95, 105, 110, 100, 101, 120,
                                                        116, 0, 0, 0, 0, 100, 0, 14, 115, 110, 97, 112, 115, 104, 111,
                                                        116, 95, 105, 110, 100, 101, 120, 106>>},
                                    ...
                                    {obj, #{
                                        {str, <<"aux_state">>} =>
                                            {bin,
                                                <<131, 116, 0, 0, 0, 2, 100, 0, 20, 112, 97, 114, 116, 121, 95, 114,
                                                    101, 118, 105, 115, 105, 111, 110, 95, 105, 110, 100, 101, 120, 116,
                                                    0, 0, 0, 0, 100, 0, 14, 115, 110, 97, 112, 115, 104, 111, 116, 95,
                                                    105, 110, 100, 101, 120, 106>>},
                                        {str, <<"ct">>} =>
                                            {str, <<"application/x-erlang-binary">>}
                                    }}}}},
            ...
            format_msg_limited(
                format_event(
                    ...
                    #{
                        ...
                        result =>
                            {ok,
                                {mg_stateproc_CallResult, {bin, <<131, 100, 0, 2, 111, 107>>},
                                                ...
                                                {str, <<"aux_state">>} =>
                                                    {bin,
                                                        <<131, 116, 0, 0, 0, 2, 100, 0, 20, 112, 97, 114, 116, 121, 95,
                                                            ...
                                                            101, 120, 116, 0, 0, 0, 7, 97, 0, 104, 2, 97, 1, 97, 1, 97,
                                                            1, 104, 2, 97, 2, 97, 2, 97, 2, 104, 2, 97, 3, 97, 3, 97, 3,
                                                            104, 2, 97, 4, 97, 4, 97, 4, 104, 2, 97, 5, 97, 5, 97, 5,
                                                            104, 2, 97, 6, 97, 6, 97, 6, 104, 2, 97, 7, 97, 7, 100, 0,
                                                            14, 115, 110, 97, 112, 115, 104, 111, 116, 95, 105, 110,
                                                            100, 101, 120, 106>>},
                                                {str, <<"ct">>} =>
                                                    {str, <<"application/x-erlang-binary">>}
                                            }}},
                                        [
                                            {mg_stateproc_Content, undefined,
                                                {arr, [
                                                    ...
                                                    {bin,
                                                        <<131, 104, 2, 100, 0, 13, 112, 97, 114, 116, 121, 95, 99, 104,
                                                            97, 110, 103, 101, 115, 108, 0, 0, 0, 2, 104, 2, 100, 0, 13,
                                                            115, 104, 111, 112, 95, 98, 108, 111, 99, 107, 105, 110,
                                                            103, 104, 3, 100, 0, 20, 112, 97, 121, 112, 114, 111, 99,
                                                            95, 83, 104, 111, 112, 66, 108, 111, 99, 107, 105, 110, 103,
                                                            109, 0, 0, 0, 11, 49, 67, 83, 87, 71, 56, 106, 48, 52, 119,
                                                            77, 104, 2, 100, 0, 7, 98, 108, 111, 99, 107, 101, 100, 104,
                                                            3, 100, 0, 14, 100, 111, 109, 97, 105, 110, 95, 66, 108,
                                                            111, 99, 107, 101, 100, 109, 0, 0, 0, 0, 109, 0, 0, 0, 27,
                                                            50, 48, 49, 57, 45, 48, 56, 45, 49, 51, 84, 49, 49, 58, 49,
                                                            57, 58, 48, 51, 46, 48, 49, 53, 50, 50, 50, 90, 104, 2, 100,
                                                            0, 16, 114, 101, 118, 105, 115, 105, 111, 110, 95, 99, 104,
                                                            97, 110, 103, 101, 100, 104, 3, 100, 0, 28, 112, 97, 121,
                                                            112, 114, 111, 99, 95, 80, 97, 114, 116, 121, 82, 101, 118,
                                                            105, 115, 105, 111, 110, 67, 104, 97, 110, 103, 101, 100,
                                                            109, 0, 0, 0, 27, 50, 48, 49, 57, 45, 48, 56, 45, 49, 51,
                                                            84, 49, 49, 58, 49, 57, 58, 48, 51, 46, 48, 49, 53, 50, 50,
                                                            50, 90, 97, 6, 106>>}
                                                ]}}
                                        ],
                                        undefined, undefined},
            ...
            format_msg_limited(
                format_event(
                    ...
                    #{
                        args =>
                            {
                                {payproc_UserInfo, <<"1CSWG2vduGe">>, {external_user, {payproc_ExternalUser}}},
                                <<"1CSWG2vduGe">>,
                                {revision, 6}
                            },
                        ...
                        result =>
                            {ok,
                                {domain_Party, <<"1CSWG2vduGe">>, {domain_PartyContactInfo, <<"hg_ct_helper">>},
                                    ...
                                    #{
                                        <<"1CSWG8j04wK">> =>
                                            {domain_Contract, <<"1CSWG8j04wK">>, undefined,
                                                {domain_PaymentInstitutionRef, 1}, <<"2019-08-13T11:19:01.387269Z">>,
                                                undefined, undefined, {active, {domain_ContractActive}},
                                    ...
                                    #{
                                        <<"1CSWG8j04wM">> =>
                                            {domain_Shop, <<"1CSWG8j04wM">>, <<"2019-08-13T11:19:01.387269Z">>,
                                                ...
                                                {domain_ShopDetails, <<"Battle Ready Shop">>, undefined}, {url, <<>>},
                        ...
                        args =>
                            {{mg_stateproc_SignalArgs,
                                {init,
                                    {mg_stateproc_InitSignal,
                                        {bin,
                                            <<131, 109, 0, 0, 0, 71, 11, 0, 1, 0, 0, 0, 11, 49, 67, 83, 87, 71, 50, 118,
                                                100, 117, 71, 101, 11, 0, 2, 0, 0, 0, 11, 49, 67, 83, 87, 71, 56, 106,
                                                48, 52, 119, 77, 12, 0, 3, 11, 0, 2, 0, 0, 0, 15, 99, 114, 101, 97, 116,
                                                101, 95, 99, 117, 115, 116, 111, 109, 101, 114, 0, 12, 0, 4, 12, 0, 1,
                                                0, 0, 0>>}}},
                        ...
                        result =>
                            {ok,
                                {mg_stateproc_SignalResult,
                                    {mg_stateproc_MachineStateChange, {mg_stateproc_Content, undefined, {obj, #{}}},
                                        [
                                            {mg_stateproc_Content, undefined,
                                                {arr, [
                                                    {arr, [
                                                ...
                                                {arr, [
                                                    {arr, [
                                                        ...
                                                        {obj, #{
                                                            ...
                                                            {str, <<"metadata">>} =>
                                                                {str,
                                                                    <<208, 174, 208, 189, 208, 208, 186, 208, 190, 208,
                                                                        180>>},
                                                            {str, <<"owner_id">>} => {str, <<"1CSWG2vduGe">>},
                                                            {str, <<"shop_id">>} => {str, <<"1CSWG8j04wM">>}
                                                        }}
            ...
            format_msg_limited(
                format_event(
                    ...
                    #{
                                ...
                                {payment_resource,
                                    {payproc_PaymentResourcePayerParams,
                                        {domain_DisposablePaymentResource,
                                            {bank_card,
                                                {domain_BankCard, <<"no_preauth">>, visa, <<"424242">>, <<"4242">>,
                        ...
                        result => {payproc_OperationNotPermitted},
                        role => client,
                        service => 'Invoicing',
